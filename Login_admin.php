...
<H1>ADMIN LOGIN</H1>
	<body>
	<div class = "loginbox">
	<img src="Images/Head.png" class = "avatar">
	<h1></h1>
...
?>
 <HTML>
		...
		<form method="post">
			...
			<div class = .login_btn><input type="submit" name="submit" id = "submit" value="Login ADMIN"></div><br/>
			<input type="submit" name="Go_Back" id = "Go_Back" value="Go Back"><br/>
			</form>
			</div>
	</body>
</HTML>